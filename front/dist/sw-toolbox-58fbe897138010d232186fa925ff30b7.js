...
c.objectStore(i).put({url:t,timestamp:n}),c.oncomplete=function(){r(e)},c.onabort=function(){o(c.error)}})},expireEntries:function(e,t,n,r){return function(e,t,n){return t?new Promise(function(r,o){var a=1e3*t,u=[],f=e.transaction(i,"readwrite"),p=f.objectStore(i)
p.index(s).openCursor().onsuccess=function(e){var t=e.target.result
if(t&&n-a>t.value[s]){var r=t.value[c]
u.push(r),p.delete(r),t.continue()}},f.oncomplete=function(){r(u)},f.onabort=o}):Promise.resolve([])}(e,n,r).then(function(n){return function(e,t){return t?new Promise(function(n,r){var o=[],a=e.transaction(i,"readwrite"),u=a.objectStore(i),f=u.index(s),p=f.count()
f.count().onsuccess=function(){var e=p.result
...
i.debug("Service Worker Toolbox is loading"),self.addEventListener("install",s.installListener),self.addEventListener("activate",s.activateListener),self.addEventListener("fetch",s.fetchListener),t.exports={networkOnly:c.networkOnly,networkFirst:c.networkFirst,cacheOnly:c.cacheOnly,cacheFirst:c.cacheFirst,fastest:c.fastest,router:o,options:r,cache:i.cache,uncache:i.uncache,precache:i.precache}},{"./helpers":1,"./listeners":3,"./options":4,"./router":6,"./strategies":10}],14:[function(e,t,n){t.exports=Array.isArray||function(e){return"[object Array]"==Object.prototype.toString.call(e)}},{}],15:[function(e,t,n){function r(e){for(var t,n=[],r=0,o=0,i="";null!=(t=g.exec(e));){var c=t[0],s=t[1],u=t.index
if(i+=e.slice(o,u),o=u+c.length,s)i+=s[1]
else{var f=e[o],p=t[2],l=t[3],h=t[4],m=t[5],d=t[6],v=t[7]
i&&(n.push(i),i="")
var x=null!=p&&null!=f&&f!==p,w="+"===d||"*"===d,y="?"===d||"*"===d,b=t[2]||"/",E=h||m||(v?".*":"[^"+b+"]+?")
n.push({name:l||r++,prefix:p||"",delimiter:b,optional:y,repeat:w,partial:x,asterisk:!!v,pattern:a(E)})}}return o<e.length&&(i+=e.substr(o)),i&&n.push(i),n}function o(e){return encodeURI(e).replace(/[\/?#]/g,function(e){return"%"+e.charCodeAt(0).toString(16).toUpperCase()})}function i(e){return encodeURI(e).replace(/[?#]/g,function(e){return"%"+e.charCodeAt(0).toString(16).toUpperCase()})}function c(e){for(var t=new Array(e.length),n=0;n<e.length;n++)"object"==typeof e[n]&&(t[n]=new RegExp("^(?:"+e[n].pattern+")$"))
return function(n,r){for(var c="",s=n||{},a=(r||{}).pretty?o:encodeURIComponent,u=0;u<e.length;u++){var f=e[u]
if("string"!=typeof f){var p,l=s[f.name]
if(null==l){if(f.optional){f.partial&&(c+=f.prefix)
continue}throw new TypeError('Expected "'+f.name+'" to be defined')}if(h(l)){if(!f.repeat)throw new TypeError('Expected "'+f.name+'" to not repeat, but received `'+JSON.stringify(l)+"`")
if(0===l.length){if(f.optional)continue
throw new TypeError('Expected "'+f.name+'" to not be empty')}for(var g=0;g<l.length;g++){if(p=a(l[g]),!t[u].test(p))throw new TypeError('Expected all "'+f.name+'" to match "'+f.pattern+'", but received `'+JSON.stringify(p)+"`")
c+=(0===g?f.prefix:f.delimiter)+p}}else{if(p=f.asterisk?i(l):a(l),!t[u].test(p))throw new TypeError('Expected "'+f.name+'" to match "'+f.pattern+'", but received "'+p+'"')
c+=f.prefix+p}}else c+=f}return c}}function s(e){return e.replace(/([.+*?=^!:${}()[\]|\/\\])/g,"\\$1")}function a(e){return e.replace(/([=!:$\/()])/g,"\\$1")}function u(e,t){return e.keys=t,e}function f(e){return e.sensitive?"":"i"}function p(e,t){for(var n=(t=t||{}).strict,r=!1!==t.end,o="",i=e[e.length-1],c="string"==typeof i&&/\/$/.test(i),a=0;a<e.length;a++){var u=e[a]
if("string"==typeof u)o+=s(u)
else{var p=s(u.prefix),l="(?:"+u.pattern+")"
u.repeat&&(l+="(?:"+p+l+")*"),o+=l=u.optional?u.partial?p+"("+l+")?":"(?:"+p+"("+l+"))?":p+"("+l+")"}}return n||(o=(c?o.slice(0,-2):o)+"(?:\\/(?=$))?"),o+=r?"$":n&&c?"":"(?=\\/|$)",new RegExp("^"+o,f(t))}function l(e,t,n){return h(t=t||[])?n||(n={}):(n=t,t=[]),e instanceof RegExp?function(e,t){var n=e.source.match(/\((?!\?)/g)
if(n)for(var r=0;r<n.length;r++)t.push({name:r,prefix:null,delimiter:null,optional:!1,repeat:!1,partial:!1,asterisk:!1,pattern:null})
return u(e,t)}(e,t):h(e)?function(e,t,n){for(var r=[],o=0;o<e.length;o++)r.push(l(e[o],t,n).source)
return u(new RegExp("(?:"+r.join("|")+")",f(n)),t)}(e,t,n):function(e,t,n){for(var o=r(e),i=p(o,n),c=0;c<o.length;c++)"string"!=typeof o[c]&&t.push(o[c])
return u(i,t)}(e,t,n)}var h=e("isarray")
t.exports=l,t.exports.parse=r,t.exports.compile=function(e){return c(r(e))},t.exports.tokensToFunction=c,t.exports.tokensToRegExp=p
var g=new RegExp(["(\\\\.)","([\\/.])?(?:(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?|(\\*))"].join("|"),"g")},{isarray:14}],16:[function(e,t,n){!function(){var e=Cache.prototype.addAll,t=navigator.userAgent.match(/(Firefox|Chrome)\/(\d+\.)/)
